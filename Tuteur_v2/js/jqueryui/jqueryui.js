!(function (t) {
    ...
    (t.widget = function (e, i, s) {
      ...
      return (
        ...
        t.each(s, function (e, s) {
          if (!t.isFunction(s)) return void (h[e] = s);
          h[e] = (function () {
            var t = function () {
        ...
        return (
          ...
          this.each(function () {
            ...
            "right" === n.my[0]
              ...
              u.offset(t.extend(P, { using: l }));
          })
        );
      }),
      (t.fn.myPosition = function (n) {
        if (!n || !n.of) return f.apply(this, arguments);
        n = t.extend({}, n);
        var p,
          m,
          ...
          C = {};
        return (
          (b = n.dimensions ? n.dimensions : s(y)),
          y[0].preventDefault && (n.at = "left top"),
          (m = b.width),
          (g = b.height),
          (v = b.offset),
        ...
        flip: {
          ...
          top: function (t, e) {
            var i,
              ...
              m = -2 * e.offset[1];
            u < 0
              ? ((s = t.top + p + f + m + e.collisionHeight - a - o) < 0 ||
                  s < r(u)) &&
                (t.top += p + f + m)
              : c > 0 &&
        ...
        for (k = "", this.maxRows = 4, C = 0; C < K[1]; C++) {
          ...
          for (
            P += M + "</tr></thead><tbody>",
              ...
              A = Math.ceil((z + S) / 7),
              H = G && this.maxRows > A ? this.maxRows : A,
              this.maxRows = H,
              E = this._daylightSavingAdjust(new Date(tt, Z, 1 - z)),
              O = 0;
            O < H;
            O++
          ) {
  ...
  var _ =
    ...
    t.widget("ui.rotateSlide", t.ui.mouse, {
      version: "1.11.4",
      ...
      _mouseStart: function (t) {
        return (this.mouseDownX = t.pageX), (this.mouseDownY = t.pageY), !0;
      },
      _mouseDrag: function (t) {
        if (
          Math.abs(this.mouseDownX - t.pageX) < 2 &&
          Math.abs(this.mouseDownY - t.pageY) < 2
        )
          return !1;
        (this.mouseDownX = t.pageX), (this.mouseDownY = t.pageY);
        var e = { x: t.pageX, y: t.pageY },
          i = this._normValueFromMouse(e);
        return this._slide(t, this._handleIndex, i), !1;
      },
      ...
      _normValueFromMouse: function (t) {
        ...
        return (
          "horizontal" === this.orientation
            ? ((e = this.elementSize.width),
              (i = t.x - this.element.offset().left))
            : ((e = this.elementSize.height),
              (i = 0),
              (i =
                270 === this.degree || -90 === this.degree
                  ? t.x - this.element.offset().left
                  : 180 === this.degree || -180 === this.degree
                  ? e - (t.y - this.element.offset().top)
                  : 90 === this.degree || -270 === this.degree
                  ? e - (t.x - this.element.offset().left)
                  : t.y - this.element.offset().top)),
          (s = i / e),
          s > 1 && (s = 1),
          s < 0 && (s = 0),
          "vertical" === this.orientation && (s = 1 - s),
      ...
      _setOption: function (e, i) {
        ...
        switch (
          ...
          case "orientation":
            ...
            break;
          case "degree":
            this._detectCssRotate(), this._refreshValue();
            break;
          case "value":
            (this._animateOff = !0),
              this._refreshValue(),
        ...
        if (this.options.values && this.options.values.length)
          this.handles.each(function (s) {
            i =
              ...
              100;
            var n =
              (100 * this.handle.width()) / 2 / this.calculatePixelTotal();
            (i -= n),
          ...
          (s = this.value()),
            ...
            (o = this._valueMax()),
            (i = o !== n ? ((s - n) / (o - n)) * 100 : 0);
          var c = (100 * this.handle.width()) / 2 / this.calculatePixelTotal();
          (i -= c),
            (u["horizontal" === this.orientation ? "left" : "bottom"] =
              i + "%"),
            this.handle.stop(1, 1)[l ? "animate" : "css"](u, r.animate),
    ...
    t.widget("ui.myTooltip", {
      ...
      options: {
        ...
        myPosition: {
          type: "default",
          absolution: { top: 0, left: 0 },
          relative: {
            follow: "default",
            align: "horizontal",
            margin: {},
            activeRect: { top: 0, left: 0, width: 0, height: 0 },
          },
        },
      },
      myShowing: {
          ...
          e &&
            ...
            s.parents().each(function () {
              ...
              s.data("ui-tooltip-open") &&
                ...
                i.close(e, !0)),
                s.attr("title") &&
                  (s.uniqueId(), (i.parents[this.id] = { element: this }));
            }),
          this._registerCloseHandlers(e, s),
          this._updateContent(s, e));
      },
      _updateContent: function (t, e) {
        ...
        (i = s.call(t[0], function (i) {
          ...
          i && this._open(e, t, i),
          "0" == i && this._open(e, t, i);
      },
      _open: function (e, i, s) {
        function n(e) {
          (l.of = {}),
            t.extend(!0, l.of, e),
            (l.dimensions = c.calculateMyDimensions(t(l.of))),
            a.is(":hidden") || a.myPosition(l);
        }
        var o,
          a,
          r,
          ...
          l = t.extend({}, this.options.position);
        if (s || "0" == s) {
          if (((e = e || window.event), this.tooltips))
            for (var u in this.tooltips) {
              o = this.tooltips[u];
              break;
            }
          if (o) return void o.tooltip.find(".ui-tooltip-content").html(s);
          i.is("[title]") &&
            ((e && "mouseover" === e.type) || i.removeAttr("title")),
            (o = this._tooltip(i)),
            (a = o.tooltip),
            this._addDescribedBy(i, a.attr("id")),
            a.find(".ui-tooltip-content").html(s),
      ...
      calculateMyDimensions: function (t) {
        var e = this.getMyDefultDimensions(t);
        return t &&
          this.options.myPosition &&
          this.options.myPosition.type &&
          "default" != this.options.myPosition.type
          ? "absolution" == this.options.myPosition.type
            ? this.getMyDimensions(
                this.options.myPosition.absolution.left,
                this.options.myPosition.absolution.top
              )
            : "relative" == this.options.myPosition.type
            ? ("horizontal" == this.options.myPosition.relative.align
                ? (this.options.myPosition.relative.margin.bottom
                    ? (e.offset.top =
                        this.options.myPosition.relative.activeRect.top +
                        this.options.myPosition.relative.activeRect.height +
                        this.options.myPosition.relative.margin.bottom)
                    : this.options.myPosition.relative.margin.top
                    ? (e.offset.top =
                        this.options.myPosition.relative.activeRect.top -
                        this.options.myPosition.relative.margin.top)
                    : (e.offset.top =
                        this.options.myPosition.relative.activeRect.top +
                        this.options.myPosition.relative.activeRect.height / 2),
                  e.offset.left <
                    this.options.myPosition.relative.activeRect.left &&
                    (e.offset.left =
                      this.options.myPosition.relative.activeRect.left),
                  e.offset.left >
                    this.options.myPosition.relative.activeRect.left +
                      this.options.myPosition.relative.activeRect.width &&
                    (e.offset.left =
                      this.options.myPosition.relative.activeRect.left +
                      this.options.myPosition.relative.activeRect.width))
                : "vertical" == this.options.myPosition.relative.align &&
                  (this.options.myPosition.relative.margin.left
                    ? (e.offset.left =
                        this.options.myPosition.relative.activeRect.left -
                        this.options.myPosition.relative.margin.left)
                    : this.options.myPosition.relative.margin.right
                    ? (e.offset.left =
                        this.options.myPosition.relative.activeRect.left +
                        this.options.myPosition.relative.activeRect.width +
                        this.options.myPosition.relative.margin.right)
                    : (e.offset.left =
                        this.options.myPosition.relative.activeRect.left +
                        this.options.myPosition.relative.activeRect.width / 2),
                  e.offset.top <
                    this.options.myPosition.relative.activeRect.top &&
                    (e.offset.top =
                      this.options.myPosition.relative.activeRect.top),
                  e.offset.top <
                    ...
                    (e.offset.top =
                      this.options.myPosition.relative.activeRect.top +
                      this.options.myPosition.relative.activeRect.height)),
              this.getMyDimensions(e.offset.left, e.offset.top))
            : e
          : e;
      },
      getMyDefultDimensions: function (e) {
        var i = e[0];
        return (
          i || (i = e),
          i && i.nodeType && 9 === i.nodeType
            ? {
                width: e.width(),
                height: e.height(),
                offset: { top: 0, left: 0 },
      ...
      getMyDimensions: function (t, e) {
        return { width: 0, height: 0, offset: { top: e, left: t } };
      },
      _registerCloseHandlers: function (e, i) {
        var s = {
          keyup: function (e) {
      ...
      mouseMove: function (t) {
        (this.myShowing.lastMovePageX &&
          this.myShowing.lastMovePageX == t.pageX &&
          this.myShowing.lastMovePageY &&
          this.myShowing.lastMovePageY == t.pageY) ||
          ((this.myShowing.lastMovePageX = t.pageX),
          (this.myShowing.lastMovePageY = t.pageY),
          this.myShowing.mouseDown &&
            !this.myShowing.mouseDownMove &&
            ((this.myShowing.mouseDownMove = !0),
            this.open(t),
            (this.myShowing.showing = !0)));
      },
      click: function (t) {
        if (this.myShowing.mouseDownMove)
          return void (this.myShowing.mouseDownMove = !1);
        this.myShowing.showing
          ? ((this.myShowing.showing = !1), this.close(t))
          : (this.open(t), (this.myShowing.showing = !0));
      },
      mouseOver: function (t) {
        this.myShowing.showing ||
          ((this.myShowing.mouseOver = !0),
          (this.myShowing.showing = !0),
          this.open(t));
      },
      mouseOut: function (t) {
        this.mouseInElement(t) ||
          (!this.myShowing.mouseDown && this.myShowing.mouseOver
            ? ((this.myShowing.mouseOver = !1),
              this.close(t),
              (this.myShowing.showing = !1))
            : (this.myShowing.mouseOut = !0));
      },
      mouseDown: function (t) {
        this.myShowing.mouseDown = !0;
      },
      mouseUp: function (t) {
        (this.myShowing.mouseDown = !1),
          this.mouseInElement(t) ||
            ((this.myShowing.mouseDownMove = !1),
            (this.myShowing.showing = !1),
            this.close(t));
      },
      mouseInElement: function (t) {
        var e = this.element,
          i = t.pageX,
          s = t.pageY,
          n = e.offset(),
      ...
      close: function (e) {
        var i,
          ...
          o = this._find(n);
        s.finish = !1;
        for (var a in this.tooltips) {
          if (((o = this.tooltips[a]), (o.finish = !1), !o))
            return void n.removeData("ui-tooltip-open");
          if (((i = o.tooltip), o.closing)) return;
          clearInterval(this.delayedShow),
            n.data("ui-tooltip-title") &&
              !n.attr("title") &&
              n.attr("title", n.data("ui-tooltip-title")),
                    ...
                    : p(l, function (s, n) {
                        ...
                        p(n.props, function (t, s) {
                          ...
                          u[o] &&
                            ...
                            ((u[o][3] = 1), n.from && (u._rgba = n.from(u[o])));
                      }),
                  this)
                : void 0
            );
          ...
          (h.fn[e] = function (e) {
            ...
            return (
              p(n, function (t, e) {
                ...
                null == s && (s = c[e.idx]), (c[e.idx] = i(s, e));
              }),
              l ? ((s = h(l(c))), (s[o] = c), s) : h(c)
            );
          }),
            p(n, function (i, s) {
              h.fn[i] ||
